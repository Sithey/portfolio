            ...
            <motion.div
                ...
                <div className="mb-6 lg:mb-0 flex flex-col">
                    <a href="https://github.com/Sithey/" target="_blank" rel="noopener noreferrer">
                        <button
                            className="mb-6 px-10 py-3 w-full sm:w-fit rounded-full bg-gradient-to-r from-blue-800 to-blue-600 hover:bg-slate-200 text-white flex items-center justify-center">
